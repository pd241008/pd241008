...
**Currently building:** IntelliDoc — an AI document intelligence
platform with a distributed async ingestion pipeline, RAG-based
...
| [ctOS Portfolio](https://ct-os-dev-porfolio.vercel.app) | Terminal-based portfolio. The terminal IS the router. | ✅ Live |
| AQI Prediction Engine | ML pollution forecast model | ✅ Live |
| NeuroTrack | AI wellness dashboard with RAG journal search | ⏳ Standby |
...
> **[ct-os-dev-porfolio.vercel.app](https://ct-os-dev-porfolio.vercel.app)**
...
![](https://nirzak-streak-stats.vercel.app/?user=pd241008&theme=dark&hide_border=false)<br/>
...
*If you read the source code of something I built and found
something interesting — that was intentional.*
